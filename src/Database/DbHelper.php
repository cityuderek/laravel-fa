...
class DbHelper {
    ...
    public static function checkConn($connName = 'mysql'){
        // logd("database.connections.mysql.username=" . config('database.connections.mysql.username'));
        // logd("database.connections.mysql.password=" . config('database.connections.mysql.password'));
        try{
            $rs = DB::connection($connName)->select('show databases;');
            // varDump($rs, 'rs');
            return true;
            ...
            logw("Failed; " . 
                ...
                ", username=" . config('database.connections.' . $connName . '.username') . 
                ", pw=" . strlen(config('database.connections.' . $connName . '.password')) . 
                "; " . $e->getMessage());
        }
